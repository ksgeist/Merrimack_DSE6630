...
longTargets %>% 
  ggplot(aes(x = Value, y = NatlComparisonHospitalDays, fill = NatlComparisonHospitalDays)) +
  geom_violin(alpha = 0.7) +
    geom_boxplot(width = 0.1) #this is the line of code directed to put in to show quartiles
  labs(title = "Which target to use?",
       subtitle = "By readmitted LOS in hospital compared to national average",
        x = "",
        y = "Rate or Score",
...
> When looking at the graphs, the main thing that looks the best when compared to the national average is actually the better than the national average group. The better group 
