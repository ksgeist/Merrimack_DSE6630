...
> There is some level of missingness to all of the columns that are in the database have some level of emptiness to them. Above is the amount of Na that are in each column and unfortunetly  there is some level of missing in each column.  

**Which column(s) are not missing any data?**

> The State column isn't missing any data but this is also  
