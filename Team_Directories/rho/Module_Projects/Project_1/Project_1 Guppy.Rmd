...
> It would be a problem if the test set had different columns than the test set because the modle was trained on a certain set of varibles. If this variable is only in the testing set the model will braeak and it will not complete or it will start to over estimate since  t
