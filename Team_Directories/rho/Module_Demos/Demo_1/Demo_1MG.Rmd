...
> The two coloumns were a form of placeholder for columns, because they were just showing data in a form in which wasn't needed. If these two columns were to stay in use then it would make the dataset itself more extented and convoluted and wouldn't be used in any other reason, so having them still in
