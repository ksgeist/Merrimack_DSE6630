...
```{r}
setwd("C:/Users/aleej/Desktop/hospital_current_data/Hospital.csv")
...
filepath <- "C:/Users/aleej/Desktop/hospital_current_data/Hospital.csv"
```
...
```{r}
files <- list.files(path = C:/Users/aleej/Desktop/hospital_current_data/Hospital.csv, pattern = "Hospital.csv")

for(f in 1:length(files)) {
    dat <- clean_names(read_csv(paste0(C:/Users/aleej/Desktop/hospital_current_data/Hospital.csv, files[f]),
