...
#My next option for this question is similar to above, but instead of a large multi-function, will create individual functions to use as arguments for a master function.
...
#Initially applying to my test_list, took several minutes and stopped process

#first attempt to make function run faster...fail
...
FY_2025_Hospital_Readmissions_Reduction_Program <-  tidy_clean_2(FY_2025_Hospital_Readmissions_Reduction_Program)#even trying on one dataset is taking several minutes. I can get it to work if I only use return, but if I try to assign the changes within the function itself it just keeps processing. Assigning outside of the function itself worked much faster. But alas, is not applying to multiple sets. 
