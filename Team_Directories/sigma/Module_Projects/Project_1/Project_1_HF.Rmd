...
```{r}
#left this as-is, as not running anyways
...
> MN:Kept with the no encoding dataset for consistency across both conditions
...
```{r, echo = FALSE}
HF_longScore <- HF_AnalyzeNoEncoding %>%
  rename(NatlComparisonHospitalDays = `ComparedToNational_Hospital return days for heart failure patients`) %>% 
