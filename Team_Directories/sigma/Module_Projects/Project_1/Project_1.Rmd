...
> MN:I chose the fully encoded dataset in an effort to be more efficient with my time.
...
> MN: I think this denisty plot further confirms my previous thoughts. There is a distinct seperation between hospital performance among the three categories in the Observed and Predicted targets. Again though, Observed is missing 600 points of data, which leads me more to the Predicted target. In the Excess and Expected targets, the distributions appears smoother and overlapping with each other, however, there is some distinction in the Worse than Average category for Excess Readmission. 
