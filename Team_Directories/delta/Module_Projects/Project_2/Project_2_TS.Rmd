...
> Your answer here.
# the split is close to a desired 80/20 split
...
> Your answer here.
# one issue is that 2020 was such a different year, that data trained on other years is very different (and predictions for 2020 may not be accurate)
...
> Your answer here.
# in a random forest OOB error is used to estimate the accuracy of the model, specifically the OOB error is related to the trees not included in the training set
...
> Your answer here.
# the default mtry for a random forest, but forcing it 1-3 since there are 3 predictor variables in the model.
