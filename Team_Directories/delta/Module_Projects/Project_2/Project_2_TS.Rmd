...
> Your answer here.
# Total deaths are always higher in counties that contain cities (Los Angeles County), probably due to high population centers.
...
> Your answer here.
# it appears as though monthly percent mortality does increase in 2020 for seval counties in southern california, but is unchanged in other couunties for 2020.
...
> Your answer here.
# the density plot of the residuals is not bell shaped (although not skewed), so the residuals are not normally distributed.
...
> Your answer here.
Mtry=1 has the best results, the highest R2 (0.037) comapared to mtry2,3,  Mtry 1 also has a slighltly lower RMSE and MAE.  R2 is also better than the OOB fit model.
...
Therefore our hypothesis appears not to be true and no further investigation was necessary
