...
load("/Users/sharonsingh/Documents/GitHub/Merrimack_DSE6630/I. Biomedical & Clinical Informatics/Project_1/FY2024_data_files/pneumoniaAnalyzeFullyEncoded2024.Rdata")
#dat2Analyze <- pneumoniaAnalyzeFullyEncoded2024
...
## Uncomment if this is your choice:
load("/Users/sharonsingh/Documents/GitHub/Merrimack_DSE6630/I. Biomedical & Clinical Informatics/Project_1/FY2024_data_files/pneumoniaAnalyzeNoEncoding2024.Rdata")
...
> The Predicted Readmission Rate target appears the most distinct, as it shows the clearest separation between hospital categories ("Better," "Same," "Worse") in both the boxplots and violin plots. This suggests it is the best target for capturing differences in pneumonia readmission rates across hospitals.
...
> After comparing the scatterplots for each readmission rate, I chose Observed Readmission Rate as the best target. The scatterplots with this y-axis showed clearer groupings and more consistent trends with hospital performance metrics like ED wait time, pneumonia death rate, and Medicare spending. This stronger visual separation suggests that Observed Readmission Rate best reflects hospital-level differences in pneumonia care outcomes. The other readmission rates (Excess, Expected, Predicted) showed more overlap and less distinct relationships, making them less useful for modeling.
