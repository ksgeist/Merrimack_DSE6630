...
```{r}
load("/Users/sharonsingh/Documents/GitHub/Merrimack_DSE6630/I. Biomedical & Clinical Informatics/Demo_1/pneumoniaFull.Rdata")
...
> This is because the stateAggTrain and stateAggTest datasets were created from raw data and we had not yet scaled or centered these values. When data is unscaled and may be skewed, the median is a more robust choice to avoid the influence of outliers. When working with scaled and centered data, either the mean or the median is typically acceptable for summarizing central tendency because centered Data Has a Mean of Zero. Both mean and median become acceptable in scaled and centered data because extreme values are minimized, and all variables are on a comparable scale with a shared center.
