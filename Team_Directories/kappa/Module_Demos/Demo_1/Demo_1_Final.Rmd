...
filepath <- "/Users/stephgarofalo/Documents/GitHub/Merrimack_DSE6630/I. Biomedical & Clinical Informatics/Demo_1/hospitals_current_data"
```
...
pneumoniaAnalyze <- pneumoniaAnalyze %>%
  mutate(NurseCommGroup = case_when(
    is.na(Hcahps_NurseComm) ~ "NA",
    Hcahps_NurseComm >= 91 ~ "91–100",
    Hcahps_NurseComm >= 81 ~ "81–90",
    Hcahps_NurseComm >= 71 ~ "71–80",
    TRUE ~ "Below 71"
  )) %>%
