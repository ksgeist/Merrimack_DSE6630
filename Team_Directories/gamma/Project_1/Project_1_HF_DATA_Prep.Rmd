...
tidyNjoin <- function(datList, filterList, hospitalInfo) {
  ...
  for(i in seq_along(datList)) {
    ...
    if(i == 4){
      ...
      valueCol <- "HcahpsLinearMeanValue"
...
write.csv(
  HF_Ready,
  file = "C:/GitHub/Merrimack_DSE6630/I. Biomedical & Clinical Informatics/Project_1/HF_Ready_Updated.csv",
  row.names = FALSE
)
```
