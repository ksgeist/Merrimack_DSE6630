...
> Cross-validation does not produce any negative R^2 values, which was possible using the OOB model. An 'mtry' of 1 still gives the best R^2 and RMSE values, with an RMSE of 0.9836851 compared to the OOB RMSE of 0.9833759. This represents a marginal improvement over the OOB model with an 'mtry.'
