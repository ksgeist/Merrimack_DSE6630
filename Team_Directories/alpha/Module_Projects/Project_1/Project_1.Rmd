...
```{r}
# Predictting on training data
train_preds <- predict(rf_model_classification, newdata = readyTrain)

# Confusion matrix
confusion_matrix <- table(Predicted = train_preds, Actual = readyTrain$ReturnDaysCategory)
print(confusion_matrix)

# Accuracy
accuracy <- mean(train_preds == readyTrain$ReturnDaysCategory)
