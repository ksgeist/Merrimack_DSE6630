...
filepath <- "~/Desktop/hospitals_current_data/" #Creates "filepath," a vector object linking to the folder of hospital data placed outside of the local repo as it is too large to push to github. 
