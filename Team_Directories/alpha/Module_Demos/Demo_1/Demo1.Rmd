...
author: "Team Alpha - Krisha Bugajski-Sharp, Trinity Tobin, and Nick Lagoni"
date: "15 May 2025"
output:
  html_document:
    toc: true
...
```{r, echo = FALSE}
files %>% 
  kable( #Creates a nice-looking table.
    format = "html", #Assigns the format to the kable as html.
    caption = "Table 1. List of hospital-level data files.") %>% #Adds a caption to the kable
    kable_styling(bootstrap_options = c("striped", full_width = F) #Adjusts the styling of the kable to have alternating stripes for rows and adjusting the width.
  )
```
