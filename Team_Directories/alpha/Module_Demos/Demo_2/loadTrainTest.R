...
if(exists("readyTrain")) {
  rm("readyTrain") } else { 
    load("/Users/krishabugajski/git_projects/Merrimack_DSE6630/Team_Directories/alpha/Module_Demos/Demo_2/readyTrain.Rdata") 
}

if(exists("readyTest")) {
  rm("readyTest") } else { 
    load("/Users/krishabugajski/git_projects/Merrimack_DSE6630/Team_Directories/alpha/Module_Demos/Demo_2/readyTest.Rdata") 
}
