...
# Un "#" here and find the file ("../../I. Biomedical & Clinical Informatics/Demo_1/pneumoniaFull.Rdata"), then put the # back 
#file.choose()

# Change this to your own directory using the file.choose() output 
# For Krisha Bugajski
load("/Users/krishabugajski/git_projects/Merrimack_DSE6630/I. Biomedical & Clinical Informatics/Demo_1/pneumoniaFull.Rdata")
...
# Now we use left join to join the lookup table to pneumoniaFull and replace at the abriviations with the full names
pneumoniaFull <- pneumoniaFull %>%
