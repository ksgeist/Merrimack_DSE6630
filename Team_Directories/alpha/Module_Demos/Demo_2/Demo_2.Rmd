...
## Now, what could you do to replace "region" in pneumoniaFull using this code? It was simpler than you thought!

# Explanation: here gsub(":.*", "", State) removes everything starting from `:` (including the :), so that "massachusetts:nantucket" becomes "massachusetts" and so on 
```
...
```{r}
## Adding this back before your source code so you have a clean and correct version:
load("../../../../I. Biomedical & Clinical Informatics/Demo_1/pneumoniaFull.Rdata")
...
## Also make sure that you have run all the code up to this point; it relies on the
## getStateName() function to work correctly! But it now works.
