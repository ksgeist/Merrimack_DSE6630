...
```{r}
merged_data <- merge(stateInfo, counties, by = "long")


merged_data <- merged_data %>%
  mutate(admission_rate = hospital_admissions / population * 1000)  
ggplot(merged_data, aes(x = median_income, y = admission_rate)) +
  geom_point() +
...
counties_sf <- st_as_sf(counties, coords = c("longitude", "latitude"), crs = 4326)
