...
> In this context, data leakage means where information from outside the training dataset is inadvertently used to create a machine learning model. We care about data leakage because it can mislead the model’s performance, invalidate conclusions, and generalize issues. 
...
First, fit the RF **except now applying the filtering for low variance / expression!**
```{r, echo = TRUE, eval=T}
