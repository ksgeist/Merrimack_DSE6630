...
# Assuming you have a data frame 'traffic_data' with columns: date, county, injuries, fatalities

# Filter data for pre and post stay-at-home order
pre_lockdown <- traffic_data %>% filter(date < as.Date("2020-03-19"))
post_lockdown <- traffic_data %>% filter(date >= as.Date("2020-03-19"))
