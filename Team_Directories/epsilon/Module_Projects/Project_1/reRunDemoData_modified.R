...
readmissionsClean <- readmissionsClean %>% 
  filter(MeasureName %in% c("HF", "AMI", "CABG"))
########################################
...
filterList <- list("MRSA Bacteremia", 
                   ...
                   c("Death rate for Coronary Artery Bypass Graft (CABG) surgery patients", 
...
## Save file for students:
save(pneumoniaFull, file = "FY2025_data_files/pneumoniaFull2025.Rdata")
## Student load file:
load("FY2025_data_files/pneumoniaFull2025.Rdata")
...
## Save file for students:
save(pneumoniaAnalyzeNoEncoding, file = "FY2025_data_files/pneumoniaAnalyzeNoEncoding2025.Rdata")
## Student load file:
load(file = "FY2025_data_files/pneumoniaAnalyzeNoEncoding2025.Rdata")
