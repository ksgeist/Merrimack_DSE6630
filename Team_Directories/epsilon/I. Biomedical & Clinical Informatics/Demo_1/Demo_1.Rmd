...
> This functin can be used again for another condition or intervention
...
```{r}
TEST_pneumoniaAnalyze$observed_readmission_rate <- (pneumoniaAnalyze$NumberOfReadmissions/pneumoniaAnalyze$NumberOfDischarges) * 100

#observed_readmission_rate

# Drop NumberOfReadmissions and NumberOfDischarges - automatically dropped in the code above
#TEST_pneumoniaAnalyze <- TEST_pneumoniaAnalyze %>% select(-NumberOfReadmissions, -NumberOfDischarges)

#head(TEST_pneumoniaAnalyze$observed_readmission_rate)
```
...
> Since observed_readmission_rate was created from two variables already in the dataset, inclulding them would cause data leakage. This would skew the results and could lead to incorrectly high accuracy metrics.
