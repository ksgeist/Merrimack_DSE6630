...
> NOTE that the selection of AMI for Advenutre 1 caused down stream issues that due to time constraints were not able to be resolved. Providing code for what was done and commenting out code where issues began after switching from AMI readmissions to death rate.

> Also note that interpretations for graphs are regarding AMI readmissions rather than deathrate as the code now reflects during our attempt to fix downstream issues.
