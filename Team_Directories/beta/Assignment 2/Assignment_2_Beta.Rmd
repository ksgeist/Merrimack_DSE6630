...
> The data appears to be in long format. Each row does not represent a single line of data. The goal of the study is to predict disease transfer in hospitals based on hospital characteristics. Preferably the data would be in wide format, with each hospital only listed once per row. 
