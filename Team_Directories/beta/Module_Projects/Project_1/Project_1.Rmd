...
# Re-define stubs here because rm(list = ls(all = TRUE)) above wiped the
# environment, deleting the stubs defined in the setup chunk.
kable_styling <- function(x, ...) x
pack_rows <- function(x, ...) x
```
...
knitr::include_graphics("project1_pipeline_workflow.svg")
```
