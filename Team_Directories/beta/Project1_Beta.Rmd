...
# Load data
load("DESeqResults_30_min.Rdata")            ## Load the results of the DESeq 30 min file
load("vst_30_min.Rdata")                     ## Load the 30 min vst data
```
...
```{r}
# Creating a basic svm model

```

```{r}
# Creating an svm model with grid search
