...
> Your answer here.gama = 0.0001302253 and cost = 1 in the training model the yield accuracy is 64.29%. This accuracy match with the cross validation svm model but it is lowell than the initial SVM.The initial SVM performed better without the hyperparameter. Accuracy (71.43%) and Kappa (0.4286) this provided a more stable model by avoiding overfitting.

##### **Question 12**: How well did hyperparameter tuning with the grid search perform?
> Your answer here.the turned Hyperparameter did not imporve while the default did.
...
> Your answer here.It is telling us that high P- value  is close to 1 and there was not diferences between perfomance
