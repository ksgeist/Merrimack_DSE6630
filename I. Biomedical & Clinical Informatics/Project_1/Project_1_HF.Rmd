...
> I selected Option 1.3.2, which loads the cleaned dataset before any categorical encoding is performed. This approach allows me to evaluate and apply encoding methods myself while preserving all other preprocessing steps completed in Demo 1.
...
dict <- tribble(
  ...
  "ComparedToNational_Hospital return days for pneumonia patients", "Hospital return days measures the number of days patients spent back in the hospital...",
  "ExpectedReadmissionRate", "The expected number of readmissions...",
  "PredictedReadmissionRate", "The number of readmissions within 30 days predicted...",
  "ExcessReadmissionRatio", "The ratio of the predicted readmission rate to the expected readmission rate...",
  "observed_readmission_rate", "Our calculation of the observed number of pneumonia-related readmissions..."
)
