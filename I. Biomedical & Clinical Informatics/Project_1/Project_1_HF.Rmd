...
> The Predicted Readmission Rate appears to be the most distinct target because hospitals with better performance generally have lower readmission rates, while worse-performing hospitals have higher rates. The separation between groups is clearer than for the other measures.
...
> No. The density plots support my earlier conclusion that Predicted Readmission Rate shows the clearest separation between better-, average-, and worse-performing hospitals.
