...
> I got a 0.82:0.18 training-to-testing split, which is very close to the common 80:20 split. I think this happened because our dataset has a fairly large number of observations compared to the number of predictors, so the formula produced a split that is close to the standard recommendation while still accounting for the size of the model.
