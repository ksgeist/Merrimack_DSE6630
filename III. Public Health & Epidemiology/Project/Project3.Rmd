...
**Note**: If you're unable to do this for any reason, you can pick back up here. You will need to download the data from [Google Drive](https://drive.google.com/file/d/15MT127zoySDS7kOfr9uhLwPSIWBCok1W/view?usp=sharing), if needed, as the shapefile is too large for GitHub yet again.
```{r}
# load("mortality_sf2.Rdata")
```
