...
#### **Question 21**: [1 point]
Notice, for example, that Cluster 1 hospitals seem to include the hospitals that had the __below__ national average return hospital days (and thus the fewest return hospital days in terms of the quantitative score). Look at how else you might broadly characterize - or segment - these hospitals.
...
```{r, echo = FALSE, fig.width=4, fig.height=4.25, warning=FALSE, message=FALSE}
