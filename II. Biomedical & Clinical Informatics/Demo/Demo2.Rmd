...
Download the [Hospitals](https://data.cms.gov/provider-data/topics/hospitals) dataset as a zip directory, and unzip it. Make sure to adjust the name and/or path of the directory in your directory if it is different.
...
paymentOnly <- Payment_and_Value_of_Care %>% 
  ...
  mutate(Payment = as.numeric(gsub("$", "", Payment))) %>% # Remove the dollar sign
